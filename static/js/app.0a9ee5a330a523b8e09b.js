 ...
 */
let url = "https://api.jzongguan.com";
// let url = 'https://api.jzongguan.com'
const Conf = {
  API_HOST: url,
  IMG_BASE_URL: "//qdimg.oss-cn-shanghai.aliyuncs.com",
  IMG_UPLOAD_URL: `${url}/imgUpload`,
  IMG_LIB_URL: `${"http://www.jzongguan.com"}/imglib`,
  VOICE_BASE_URL: `${url}/voices/`,
  QRCODE_URL: `${url}/_tool_/qr-img.php?val=`,
  ...
  IMG_TOOL_RUL: "http://tool.jzongguan.com/static/img",
  Keys: {
    LOGIN_FLAG: "islogin"
  },
...
const SvName = {
  ...
  // 核销
  SHOP_ARG_QUERY: "msite/shopArgQuery",
  MT_APP_ORDER_CHECK: "msite/mtAppOrderCheck",
  MT_APP_ORDER_CREATE: "msite/mtAppOrderCreate",
  POI_APP_ORDER_CHECK: "msite/poiAppOrderCheck",
  POI_APP_ORDER_CREATE: "msite/poiAppOrderCreate",
  // 散客入场券
  ENTRY_TICKET_PRODUCT_QUERY: "msite/entryTicketProductQuery",
  ENTRY_TICKET_ORDER_QUERY: "msite/entryTicketOrderQuery",
  ENTRY_TICKET_ORDER_CREATE: "msite/entryTicketOrderCreate",
  ENTRY_TICKET_ORDER_FINISH: "msite/entryTicketOrderFinish",
  ENTRY_TICKET_ORDER_CHECKIN: "msite/entryTicketOrderCheckin"
};
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  created() {
    // 测试
    $.data.shop.bottomMenus = "0:首页,1:会员卡,3:团课,16:美团,17:抖音,5:活动";
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_36d95116_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__ = __webpack_require__(247);
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_36d95116_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__["a" /* default */],
...
const dyVerIfyCoupon = r => __webpack_require__.e/* require.ensure */(1).then((() => r(__webpack_require__(565))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);

//-- activity pages
const activityHome = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(566))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const coupons = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(567))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const couponDetail = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(568))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const couponSale = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(569))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const guestCoupons = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(570))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const lottery = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(571))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const lotteryRun = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(572))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const shareItem = r => __webpack_require__.e/* require.ensure */(4).then((() => r(__webpack_require__(573))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const groupbuyProductList = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(574))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const groupbuyProduct = r => __webpack_require__.e/* require.ensure */(2).then((() => r(__webpack_require__(575))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const groupbuyProductSale = r => __webpack_require__.e/* require.ensure */(2).then((() => r(__webpack_require__(576))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const groupbuyPaySuccess = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(577))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const groupbuyTeam = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(578))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const memberPhotoShare = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(579))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const bargain = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(580))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const bargainMain = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(581))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const bargainMylaunch = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(582))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const bargainProductSale = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(583))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const eventList = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(584))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const eventOfMine = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(585))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const eventDetail = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(586))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const eventFillIn = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(587))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const summary = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(588))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const smashGoldenEggList = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(589))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const smashGoldenEgg = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(590))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const smashGoldenEggOfMine = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(591))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const secondKillList = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(592))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const secondKillDetail = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(593))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const secondKillOfMine = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(594))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const secondKillSale = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(595))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const fitEntryTicketMy = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(596))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const fitEntryTicketDetail = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(597))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const fitEntryTicket = r => __webpack_require__.e/* require.ensure */(0).then((() => r(__webpack_require__(598))).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
const router = new __WEBPACK_IMPORTED_MODULE_1_vue_router__["a" /* default */]({
  routes: [{ path: "/", component: index, meta: { title: "健总管" } }, { path: "/not-found", component: notFound, meta: { title: "404" } }, { path: "/shop-home", component: shopHome, meta: { id: "home" } }, {
    ...
    component: dyVerIfyCoupon,
    meta: { authLogin: true, title: "抖音核销" }
  }, {
    path: "/shop-cards",
    component: shopCards,
  ...
  // 散客入场券
  {
    path: "/fit-entry-ticket-my",
    component: fitEntryTicketMy,
    meta: { authLogin: true }
  }, {
    path: "/fit-entry-ticket-detail/:productId",
    component: fitEntryTicketDetail,
    meta: { authLogin: true }
  }, {
    path: "/fit-entry-ticket",
    component: fitEntryTicket,
    meta: { authLogin: true }
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_d68c7fcc_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bottom_nav_vue__ = __webpack_require__(437);
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_d68c7fcc_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_bottom_nav_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
